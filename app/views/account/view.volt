    ...
    <div class="row">
      ...
      <div class="four wide column">
        <div class="ui sticky">
          ...
          <div class="ui list">
            <div class="item">
              <a href="https://dsite.io/@{{ account.name }}" class="ui fluid primary icon small basic button" target="_blank">
                <i class="external icon"></i>
                View Account on dSite
              </a>
            </div>
            <div class="item">
              <a href="https://bex.network/@{{ account.name }}" class="ui fluid teal icon small basic button" target="_blank">
                <i class="external icon"></i>
                View Account on bex.network
              </a>
            </div>
          </div>
          <table class="ui small definition table">
            <tbody>
              ...
              <tr {% if account.vesting_withdraw_rate and account.vesting_withdraw_rate > 1 %}data-popup data-html="<table class='ui small definition table'><tr><td>Power Down - Rate</td><td>-<?php echo $this->convert::vest2bp($current->vesting_withdraw_rate, " BP"); ?></td></tr><tr><td>Power Down - Datetime</td><td><?php echo gmdate("Y-m-d H:i:s e", (string) $account->next_vesting_withdrawal / 1000) ?></td></tr></table>" data-position="left center" data-variation="very wide"{% endif %}>
                <td>BP</td>
                <td>
                  <div class="ui tiny header">
                    <?php echo $this->convert::vest2bp($current->vesting_shares); ?>
                  </div>
                </td>
              </tr>
              <tr data-popup data-html="<table class='ui small definition table'><tr><td>Balance</td><td><?php echo number_format($account->balance, 3, '.', ','); ?></td></tr><tr><td>Savings Balance</td><td><?php echo number_format($account->savings_balance, 3, '.', ','); ?></td></tr>{% if account.vesting_withdraw_rate and account.vesting_withdraw_rate > 1 and not account.withdraw_routes %}<tr><td>Power Down - Rate</td><td>+<?php echo $this->convert::vest2bp($current->vesting_withdraw_rate, " BEX"); ?></td></tr><tr><td>Power Down - Datetime</td><td><?php echo gmdate("Y-m-d H:i:s e", (string) $account->next_vesting_withdrawal / 1000) ?></td></tr>{% endif %}</table>" data-position="left center" data-variation="very wide">
                <td>BEX</td>
                <td>
                  <div class="ui tiny header">
              ...
              <tr data-popup data-html="<table class='ui small definition table'><tr><td>Balance</td><td><?php echo number_format($account->bbd_balance, 3, '.', ','); ?></td></tr><tr><td>Savings Balance</td><td><?php echo number_format($account->savings_bbd_balance, 3, '.', ','); ?></td></tr><tr><td>Next Interest (10% APY)</td><td><?php echo gmdate("Y-m-d H:i:s e", strtotime("+30 days", (string) $account->bbd_last_interest_payment / 1000)); ?></td></tr></table>" data-position="left center" data-variation="very wide">
                <td>BBD</td>
                <td>
                  <div class="ui tiny header">
                    <?php echo number_format($account->total_bbd_balance, 3, '.', ','); ?>
