...
<div class="ui blue inverted top fixed mobile hidden menu">
  <div class="ui container">
    <a href="/" class="brand">
      <span class="header item">dPay</span>
    </a>
    ...
    <div class="right menu">
      ...
      <div class="ui category search item">
        <div class="ui icon input">
          <input class="prompt" type="text" placeholder="Search dPay accounts...">
          <i class="search icon"></i>
        </div>
        <div class="results"></div>
      </div>
      <div class="ui dropdown item">
        ...
        <div class="menu">
          ...
          <a class="item" href="https://dpaytest.network{{ router.getRewriteUri() }}">dPay Testnet</a>
        </div>
      </div>
    </div>
  </div>
