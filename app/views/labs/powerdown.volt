        ...
        <table class="ui small striped table">
          <thead>
            <tr>
              ...
              <th class="right aligned">~<?php echo $this->convert::vest2bp($upcoming_total, " BEX", 0); ?></th>
            </tr>
          </thead>
          <tbody>
            {% for day in upcoming %}
            <tr>
              ...
              <td class="right aligned">~<?php echo $this->convert::vest2bp($day->withdrawn, " BEX", 0); ?></td>
            </tr>
            {% endfor %}
          </tbody>
        </table>
        ...
        <table class="ui small striped table">
          <thead>
            <tr>
              ...
              <th class="right aligned">~<?php echo $this->convert::vest2bp($previous_total, " BEX", 0); ?></th>
            </tr>
          </thead>
          <tbody>
            {% for day in previous %}
      ...
      <div class="column">
        ...
        <table class="ui small striped attached table">
          <thead>
            <tr>
              <th></th>
              <th class="right aligned">dPay Deposited</th>
