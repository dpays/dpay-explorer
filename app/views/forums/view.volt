    ...
    <div class="row">
      <div class="three wide center aligned column">
        <div class="mobile hidden">
          <img src="https://img.dpayid.io/@{{ post.author }}?size=80" class="ui tiny centered spaced circular bordered image">
        ...
        <div class="mobile visible">
          <img src="https://img.dpayid.io/@{{ post.author }}?size=60" class="ui right floated spaced circular bordered image">
        </div>
      </div>
      <div class="thirteen wide column">
              ...
              <div class="metadata">
                <div class="date">
                  ...
                  {% if post.origin() %}
                    ...
                    {% elseif post.origin() == 'dPix' %}
                    <a href="http://dpix.io/">dPix</a>
                    {% else %}
                      Unknown - [{{ post.origin() }}]
                    {% endif %}
                    )
                ...
                <div class="actions">
                  ...
                  <a href="https://dsite.io{{ post.url }}" target="_blank">dsite</strong>.io</a>
                  <a href="https://bex.network/tag/@{{ post.author }}/{{ post.permlink }}" target="_blank">BEX.network</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row stackable">
      ...
      <div class="ten wide column">
        ...
        <div class='dpayid reply'>
          <form class='ui reply form' action='http://dpayjs.com/sign/comment' method='get' target='iframe'>
    ...
    <div class="ui notice modal">
      ...
      <div class="content">
        <div class="ui padded basic segment" style="font: 16px">
          ...
          <p>
            The signing of these transactions uses tools provided by <a href="https://dpayid.io/" target="_blank">DPayId.com</a>. BexNetwork is embedding and using these tools to allow your actions to take place.
          </p>
          <p>
...
$( document ).ready(function() {
        ...
        onSuccess: function(e){
          var form = $(this),
              ...
              embed = $(".ui.modal.dpayid .ui.embed")
                .attr("data-url", "https://dpayjs.com/sign/comment?" + data);
          $('.notice.modal')
            .modal('show')
          ;
          $(".ui.modal.dpayid")
  ...
  $("a.reply[data-permlink][data-author]").on('click', function() {
    var permlink = $(this).attr("data-permlink"),
        ...
        form = $("<form class='ui reply form' action='http://dpayjs.com/sign/comment' method='get' target='iframe'>").append(parent_author, parent_permlink, json_metadata, body, button),
